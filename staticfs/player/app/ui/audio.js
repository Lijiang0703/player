...
define([
    ...
    player.audio = {
        ...
        *获取radio标签的资源
        ...
        getRadio:function(){
            this.navigator();
            navigator.getMedia({audio:true},function(stream){     //success   获取媒体流  媒体类型为audio
                ...
                if(player.isHas){
                    ...
                    //var source = audioContext.createMediaStreamSource(stream);  //获取麦克风
            ...
            //    //var source = audioContext.createMediaElementSource(audio);  //获取radio标签中的source
            //    var source = audioContext.createMediaStreamSource(stream);  //获取radio标签中的source
            //    source.connect(analyser);
            //    analyser.connect(audioContext.destination);
            //    player.isHas = false;
            //}
